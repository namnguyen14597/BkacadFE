    ...
    const handleSearch = () => {
        apiLoggedInInstance({
            ...
            filteredData = filteredData.filter(item => {
                const yearString = String(item.year); // Chuyển đổi item.year thành chuỗi
                return item.name.includes(filterValue.name) && yearString.includes(filterValue.year);
            });
                ...
                <table className='border border-[#F0F0F0] w-full  mt-10'>
                    ...
                    <tbody className=''>
                        <tr className='border-b '>
                            ...
                            <td>
                                <input value={filterValue.year} onChange={(event) => {
                                    setFilterValue(pre => ({ ...pre, year: event.target.value }))
                                }} type="text" className='border border-gray-300 bg-white rounded-md' />
                            </td>
                        </tr>
                        {data.length === 0 && (
                        ...
                        {paginatedData.map((field, index) => (
                            <tr className='bg-white border-b dark:bg-gray-800 dark:border-gray-700 items-center'>
                                ...
                                <td className='px-1 py-4'>{field.year}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
                        ...
                        <div>
                            <div className='flex justify-between gap-[100px] px-[30px] mb-5'>
                                ...
                                <div className='w-1/2'>
                                    ...
                                    <input value={editField.year} onChange={(e) => {
                                        setEditField(pre => ({ ...pre, year: e.target.value }))
